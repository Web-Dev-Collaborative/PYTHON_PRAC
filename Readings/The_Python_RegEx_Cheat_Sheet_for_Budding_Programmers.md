...
string<span class="math inline">$Check if a variable ends with a set of stringsimport re someText="Hello regular expression" a=re.findall("expression$</span>", someText)
